...
for i in range(0, len(data_points_stripped)):
    if i % 4 == 0:
        customer.append(data_points_stripped[i])
    elif i % 4 == 1:
        amount_spent.append(data_points_stripped[i])
    elif i % 4 == 2:
        color.append(data_points_stripped[i])
    elif i % 4 == 3:
...
print("Amount of 'purple' sold: " + str(new_color_list.count("purple")))
print("Amount of 'red' sold: " + str(new_color_list.count("red")))
print("Amount of 'green' sold: " + str(new_color_list.count("green")))
print("Amount of 'black' sold: " + str(new_color_list.count("black")))
print("Total Revenue = $" + str(total_sales/100))